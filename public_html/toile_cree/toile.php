...
<head>
    ...
    <link rel="stylesheet" href="../css/creetoile.css">
    <title>toile en cours de création</title>
</head>

<body>
    <div id="container">
        <h1 class="form_title">Votre toile est en cours de création...</h1>
        <br>
        <div id="formulaire">
            <div class="form_section">
                <a href="../pages/mes_toiles.php">Retour à mes toiles</a>
            </div>
            <?php
