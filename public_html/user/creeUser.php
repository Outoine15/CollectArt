			...
			<div id="formulaire">
				<form method="POST" action="creeUser.php">
					...
					<div class="form_section">
						...
						<p class="form_contrainte">8 caractères ou plus dont au moins : 1 majuscule, 1 minuscule et 1
							chiffre</p>
					</div>
					...
					<div class="form_section">
						<div class="form_header">
							...
							<div class="pwd_container">
								<input type="checkbox" id="checkbox_pwd_confirmation"
									onclick="passwordSeeHide('checkbox_pwd_confirmation', 'user_pwd_confirmation')">
